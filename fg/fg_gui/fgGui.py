...
class FHIRGuardGUI(QMainWindow):
	...
	def create_logs_tab(self):
		...
		self.log_PID_combo.addItems([str(instance.get("PID", "")) for instance in self.running_instances if "PID" in instance])
	...
	def update_instances_table(self):
		...
		self.log_PID_combo.addItems([inst["PID"] for inst in self.running_instances if "PID" in inst])
